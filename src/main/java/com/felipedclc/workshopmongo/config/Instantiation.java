...
import com.felipedclc.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem brou", sdf.parse("23/01/2020"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("28/01/2020"), new AuthorDTO(bob));
		CommentDTO c3= new CommentDTO("Tenha um ótimo dia!", sdf.parse("30/01/2020"), new AuthorDTO(alex));
